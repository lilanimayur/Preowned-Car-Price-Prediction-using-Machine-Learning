...
#photo = PhotoImage(file="Car-Buying-Sites-910x420.png")
#photolabel =Label(miFrame, image=photo)
#photolabel.pack()

miFrame2 = Frame()
miFrame2.pack()
miFrame2.config(width="1920", heigh=("1080"))
...
lbl1 = Label(window,text="Location                                          :",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl1.place(x=100, y=210)
E1=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E1.place(x=350,y=210)

lbl2 = Label(window,text="Year                           ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl2.place(x=100, y=270)
E2=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E2.place(x=350,y=270)

lbl3 = Label(window,text="Kilometers Driven                               ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl3.place(x=100, y=330)
E3=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E3.place(x=350,y=330)

lbl4 = Label(window,text="Fuel Type                              ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl4.place(x=100, y=390)
list1 = ['CNG', 'Diesel', 'Petrol', 'LPG', 'Electric'];
c = StringVar()
E4= OptionMenu(window, c, *list1)
E4.config(width=35, height=2)
c.set('Select Fuel Type')
E4.place(x=350,y=390)

lbl5 = Label(window,text="Transmission Type ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl5.place(x=100, y=450)
option1 = StringVar()
...
lbl6 = Label(window,text="Owner Type                        ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl6.place(x=100, y=510)
list2 = ['First', 'Second', 'Third', 'Fourth & Above'];
c1 = StringVar()
E5= OptionMenu(window, c1, *list2)
E5.config(width=35, height=2)
c1.set('Select Owner Type')
E5.place(x=350,y=510)

lbl7 = Label(window,text="Mileage                       ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl7.place(x=100, y=570)
E6=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E6.place(x=350,y=570)

lbl8 = Label(window,text="Engine (CC)                                  ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl8.place(x=100, y=630)
E7=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E7.place(x=350,y=630)

lbl9 = Label(window,text="""Power (BHP)                   """,font=("Times ",24),bg="#36688D",fg="WHITE")
lbl9.place(x=100, y=690)
E8=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E8.place(x=350,y=690)

lbl10 = Label(window,text="Seats                      ",font=("Times ",24),bg="#36688D",fg="WHITE")
lbl10.place(x=100, y=750)
E9=Entry(window,bd=9,width=24,font = ('courier', 16, 'bold'))
E9.place(x=350,y=750)
